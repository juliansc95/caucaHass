            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> Gastos Adecuacion y renovacion
                        ...
                        :data   = arrayGastoEx
                        worksheet = "GastosRenovacion"
                        name    = "GastosRenovacion.xls">
                        Excel
                        </export-excel>
                        <export-excel
                        class   = "button btn btn-success"
    ...
    export default {
        ...
        methods : {
            listarGastos (page,buscar,criterio){
                let me=this;
                var url= 'renovacion?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio;
            ...
            registrarGasto(){
                ...
                let me = this;
                axios.post('renovacion/registrar',{
