                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    <select class="form-control col-md-3" v-model="criterio">
                                      <option value="VentaNro">Numero venta</option>
                                       <option value="Documento">Numero documento tercero</option>
                                    </select>
                            ...
                            <table class="table table-bordered table-striped table-sm">
                                ...
                                <tbody>
                                    <tr v-for="venta in arrayVenta" :key="venta.id">
                                        <td v-text="venta.VentaNro"></td>
                                        <td v-text="venta.Fecha"></td>
                                        <td v-text="venta.CodProducto"></td>
                                        <td v-text="venta.DescripcionProducto"></td>
                                        <td v-text="venta.Cantidad"></td>
                                        <td v-text="venta.ValorBruto"></td>
                                        <td v-text="venta.Descuento"></td>
                                        <td v-text="venta.ValorNeto"></td>
                                        <td v-text="venta.Iva"></td>
                                        <td v-text="venta.ValorIva"></td>
                                        <td v-text="venta.ImpuestoConsumo"></td>
                                        <td v-text="venta.TotalItem"></td>
                                        <td v-text="venta.Documento"></td>
                                        <td v-text="venta.NombreTercero"></td>
                                    </tr>                                
                                </tbody>
                            </table>
                        </div>
...
<script>
    ...
    export default {
        ...
        methods : {
            ...
            cargarPdf(){
                //window.open('/caucahass/public/ventas/listarPdf');
                 window.open('http://caucahass.sttmserver.com/ventas/listarPdf');
            },
            reporteDiario(){
                //window.open('/caucahass/public/ventas/listarDiario');
                window.open('http://caucahass.sttmserver.com/ventas/listarDiario');
            },
